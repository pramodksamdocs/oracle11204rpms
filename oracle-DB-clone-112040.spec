...
%define home product/11.2.0.4
Name: oracle-DB-clone-112040
Version: 0.1
Release: 1.ol7
...
/usr/bin/echo "cloning the oracle database 11.2.0.4  home now to $ORACLE_HOME"
/usr/bin/mkdir -p $ORACLE_HOME

/usr/bin/tar --gzip -xf /stage/11.2.0.4.tar.gz -C /opt/app/oracle/product
